"""LSTM 모델 평가 유틸리티 (MAE/RMSE/방향 정확도/커버리지).

실행 (레포 루트에서): python -m agents.simulation.evaluate_model --ticker 005930
"""
import logging
import argparse
import json
...
def evaluate_model(
    ...
    from agents.simulation.model import build_training_windows
...
if __name__ == "__main__":
    ...
    from agents.simulation.model import get_or_train_model
